...
our %config = (
  AR => "ar",
  ARFLAGS => [ "r" ],
  CC => "/Applications/Xcode.app/Contents/Developer/usr/bin/gcc --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -mmacosx-version-min=10.6 -arch Universal",
  CFLAGS => [  ],
  CPPDEFINES => [ "OPENSSL_NO_ASYNC=1" ],
  CPPFLAGS => [  ],
  CPPINCLUDES => [  ],
  CXX => "/Applications/Xcode.app/Contents/Developer/usr/bin/g++ --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -mmacosx-version-min=10.6 -arch Universal",
  CXXFLAGS => [  ],
  ...
  builddir => ".",
  cflags => [  ],
  conf_files => [ "Configurations/99-livecode.conf" ],
  cppflags => [  ],
  cxxflags => [  ],
  defines => [ "NDEBUG" ],
  ...
  openssldir => "",
  options => "enable-shared -DOPENSSL_NO_ASYNC=1 --prefix=/Users/emily-elizabethhoward/livecode/prebuilt/build/install/mac/Universal no-afalgeng no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-hw no-makedepend no-md2 no-msan no-pic no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-threads no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "darwin-thread-multi-2level",
  perl_cmd => "perl",
  perl_version => "5.34.1",
  perlargv => [ "no-rc5", "no-hw", "no-threads", "shared", "-DOPENSSL_NO_ASYNC=1", "--prefix=/Users/emily-elizabethhoward/livecode/prebuilt/build/install/mac/Universal", "livecode_darwin-Universal-cc" ],
  perlenv => {
      "AR" => "",
      "BUILDFILE" => undef,
      "CC" => "/Applications/Xcode.app/Contents/Developer/usr/bin/gcc --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk -mmacosx-version-min=10.6 -arch Universal",
  ...
  prefix => "/Users/emily-elizabethhoward/livecode/prebuilt/build/install/mac/Universal",
  processor => "",
  ...
  sourcedir => ".",
  target => "livecode_darwin-Universal-cc",
  tdirs => [ "ossl_shim" ],
  version => "1.1.1g",
...
our %target = (
  ...
  CC => "cc",
  HASHBANGPERL => "/usr/bin/env perl",
  RANLIB => "CODE(0x7c91f9af8)",
  RC => "windres",
  _conf_fname_int => [ "Configurations/99-livecode.conf", "Configurations/shared-info.pl" ],
