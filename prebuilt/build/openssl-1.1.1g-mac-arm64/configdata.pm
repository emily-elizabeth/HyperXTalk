...
our %config = (
  ...
  libdir => "",
  major => "1",
  makedepprog => "\$(CROSS_COMPILE)/Applications/Xcode.app/Contents/Developer/usr/bin/gcc --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk -mmacosx-version-min=11.0 -arch arm64",
  minor => "1.1",
  ...
  openssldir => "",
  options => "enable-shared -DOPENSSL_NO_ASYNC=1 --prefix=/Users/emily-elizabethhoward/livecode/prebuilt/build/install/mac/arm64 no-afalgeng no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-hw no-md2 no-msan no-pic no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-threads no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "darwin-thread-multi-2level",
  perl_cmd => "perl",
  perl_version => "5.34.1",
  perlargv => [ "no-rc5", "no-hw", "no-threads", "shared", "-DOPENSSL_NO_ASYNC=1", "--prefix=/Users/emily-elizabethhoward/livecode/prebuilt/build/install/mac/arm64", "livecode_darwin64-arm64-cc" ],
  perlenv => {
      "AR" => "",
      "BUILDFILE" => undef,
      "CC" => "/Applications/Xcode.app/Contents/Developer/usr/bin/gcc --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX26.2.sdk -mmacosx-version-min=11.0 -arch arm64",
  ...
  prefix => "/Users/emily-elizabethhoward/livecode/prebuilt/build/install/mac/arm64",
  processor => "",
  ...
  sourcedir => ".",
  target => "livecode_darwin64-arm64-cc",
  tdirs => [ "ossl_shim" ],
  version => "1.1.1g",
