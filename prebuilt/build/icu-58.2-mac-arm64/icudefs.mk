...
VERSION = 58.2
UNICODE_VERSION = 9.0
SO_TARGET_VERSION = 58.2
SO_TARGET_VERSION_MAJOR = 58
...
ICUDATA_BASENAME_VERSION = $(ICUPREFIX)dt58
# the entry point is almost like the basename, but has the lib suffix.  
ICUDATA_ENTRY_POINT = $(ICUPREFIX)dt58 
ICUDATA_CHAR = l
...
CPPFLAGS =  $(THREADSCPPFLAGS)  -DU_HAVE_ATOMIC=1 -DU_HAVE_STRTOD_L=1 
