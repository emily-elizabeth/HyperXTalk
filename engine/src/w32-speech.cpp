...
//
// Windows voice command backend — stub implementation.
//
// Speech recognition on Windows is not yet implemented.
...
bool MCPlatformStartListening(MCStringRef /*p_language*/)
{
    ...
    /* UNCHECKED */ MCStringCreateWithCString(
        "startListening: speech recognition is not yet supported on Windows", t_err);
